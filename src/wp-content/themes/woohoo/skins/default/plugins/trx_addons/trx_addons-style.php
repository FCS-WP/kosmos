...
if ( ! function_exists( 'woohoo_trx_addons_get_css' ) ) {
	add_filter( 'woohoo_filter_get_css', 'woohoo_trx_addons_get_css', 10, 2 );
	function woohoo_trx_addons_get_css( $css, $args ) {
