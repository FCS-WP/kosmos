...
if ( ! function_exists( 'woohoo_woocommerce_get_css' ) ) {
	add_filter( 'woohoo_filter_get_css', 'woohoo_woocommerce_get_css', 10, 2 );
	function woohoo_woocommerce_get_css( $css, $args ) {
...
$fdir = woohoo_get_file_dir( 'plugins/woocommerce/woocommerce-skin.php' );
if ( ! empty( $fdir ) ) {
    require_once $fdir;
}
