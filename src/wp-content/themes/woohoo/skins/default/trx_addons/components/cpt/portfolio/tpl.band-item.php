...
if ( ! woohoo_storage_get( 'lazy_load_off' ) ) {
    woohoo_storage_set( 'lazy_load_off', true );
		...
		data-details="<?php
			echo esc_attr( '<div class="post_details">'
								...
								. '<div class="post_description">'
									. $details
									. ( empty( $woohoo_template_args['hide_excerpt'] )
										? '<div class="post_description_content">' . get_the_excerpt() . '</div>'
										: ''
										)
									. '<a href="' . esc_url( $link ) . '" class="theme_button post_readmore"><span class="post_readmore_label">' . esc_html__( 'Learn more', 'woohoo' ) . '</span></a>'
								. '</div>'
							. '</div>'
						);
		?>"
...
>
    ...
    <div class="post_content_wrap">
        ...
        <?php if(empty( $woohoo_template_args['hide_excerpt'])) { ?>
