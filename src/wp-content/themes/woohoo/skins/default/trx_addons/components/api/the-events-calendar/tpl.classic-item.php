...
if ( has_post_thumbnail() ) {
    $image = trx_addons_get_attachment_url(
        ...
        apply_filters('trx_addons_filter_thumb_size', woohoo_get_thumb_size('masonry-big'), 'events-classic')
    );
}
    ...
    <div class="sc_events_item_content">
        ...
        <div class="sc_events_item_content_inner">
            ...
            <div class="sc_events_item_content_inner_top">
                <div class="sc_events_item_meta_categories"><?php woohoo_show_layout(trx_addons_get_post_terms(' ', get_the_ID(), Tribe__Events__Main::TAXONOMY))?></div>
            </div>
                ...
                <div class="sc_events_item_meta">
                    <span class="sc_events_item_meta_item sc_events_item_meta_date"><?php
                        ...
                        echo sprintf( $dt < date('Y-m-d')
                                        ? esc_html__('Started on %1$s to %2$s', 'woohoo')
                                        : esc_html__('Starting %1$s to %2$s', 'woohoo'),
