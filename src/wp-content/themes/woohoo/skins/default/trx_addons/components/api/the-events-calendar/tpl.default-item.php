...
<div class="sc_events_item sc_item_container post_container">
	...
	<div class="sc_events_item_info">
        ...
        <div class="sc_events_item_date_start">
            <div class="sc_events_item_date_day"><?php woohoo_show_layout( date_i18n('d', strtotime($dt)) )?></div><div class="sc_events_item_date_month"><?php woohoo_show_layout( date_i18n('M, Y', strtotime($dt)) )?></div>
        </div>
    ...
    if ($cost !== '') { ?>
        <div class="sc_events_item_price<?php echo esc_attr('Free' == $cost ? ' free_price' : '')?>"><?php woohoo_show_layout($cost);?></div><?php
    } ?>
