...
while ( have_posts() ) { the_post();
	...
	$woohoo_cpt_team_article_info_output = '';
	ob_start();
		...
		<div class="team_member_details">
			...
			if ( $need_info ) {
				...
				<div class="team_member_brief_info">
					<h3 class="section_title team_member_brief_info_title"><?php esc_attr_e('Biography', 'woohoo'); ?></h3>
	...
	$woohoo_cpt_team_article_info_output = ob_get_contents();
	ob_end_clean();

	do_action('trx_addons_action_after_article', 'team.single', $woohoo_cpt_team_article_info_output);
