					...
					<div class="categories_list_item">
						...
						?><div class="categories_list_image post_featured_bg hover_link"><?php
							$src = empty($image)
								...
								: trx_addons_add_thumb_size($image, woohoo_get_thumb_size('full'));
							$attr = trx_addons_getimagesize($src);
							?>
							<div class="post_thumb bg_in <?php echo woohoo_add_inline_css_class('background-image: url('. esc_url($src).');'); ?>"></div>
						</div><?php
						?>
