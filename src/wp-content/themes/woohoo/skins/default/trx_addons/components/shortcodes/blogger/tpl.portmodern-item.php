		...
		if ( substr( $k, 0, 4 ) == 'meta') {
			...
			the_title( '<h1 class="sc_blogger_item_title entry-title"'
                        ...
                        . ' data-details="' . esc_attr( '<div class="post_details">'
                            ...
                            . '<a href="' . esc_url( get_permalink() ) . '" class="theme_button post_readmore"><span class="post_readmore_label">' . (!empty($args['more_text']) ? esc_html($args['more_text']) : esc_html__( 'Learn more', 'woohoo' )) . '</span></a>'
                            . '</div>'
                            . '</div>'
                        ) . '"'
						. '>',
