...
if (!empty($show_cart)) {
	...
	?>>
		...
		<span class="sc_layouts_item_details sc_layouts_cart_details">
			...
			<span class="sc_layouts_item_details_line2 sc_layouts_cart_totals">
				<span class="sc_layouts_cart_items"><?php
					echo esc_html($cart_items) . ' ' . esc_html(_n('item', 'items', $cart_items, 'woohoo'));
				?></span>
				- 
		...
		<div class="sc_layouts_cart_widget widget_area">
			...
			<h5 class="sc_layouts_item_text"><?php esc_html_e('Cart', 'woohoo'); ?></h5>
			<?php
			...
			// Show preview Cart
				...
				?><div class="sc_layouts_cart_preview"><?php esc_html_e('Placeholder for Cart items', 'woohoo'); ?></div><?php
			}
			?>
