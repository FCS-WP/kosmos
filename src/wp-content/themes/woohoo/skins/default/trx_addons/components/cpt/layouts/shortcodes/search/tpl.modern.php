...
$main_logo_args =  woohoo_get_logo_image();
        ...
        <div class="search_wrap<?php if (!empty($args['ajax'])) echo ' search_ajax'; if (!empty($args['scheme_search'])) echo ' scheme_'. esc_attr($args['scheme_search'])?>">
            ...
            <div class="search_form_wrap">
                <form role="search" method="get" class="search_form" action="<?php echo esc_url( home_url( '/' ) ); ?>">
                    ...
                    ?>" name="post_types">
                    <input type="text" class="search_field" placeholder="<?php esc_attr_e( 'Type words and hit enter', 'woohoo' ); ?>" value="<?php echo esc_attr( get_search_query() ); ?>" name="s">
