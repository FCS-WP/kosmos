...
?>>
	...
	trx_addons_get_template_part('templates/tpl.featured.php',
								...
								apply_filters( 'trx_addons_filter_args_featured', array(
												...
												'thumb_bg' => true,
												'hover' => 'info_anim',
												'thumb_size' => woohoo_get_thumb_size('full'),
...
if ( !function_exists( 'woohoo_sc_icons_merge_scripts' ) ) {
	add_action("trx_addons_filter_merge_scripts", 'woohoo_sc_icons_merge_scripts');
	function woohoo_sc_icons_merge_scripts($list) {
