...
if ( ! function_exists('woohoo_get_not_selected_text') ) {
	/**
	 ...
	 */
	function woohoo_get_not_selected_text( $label ) {
		return apply_filters( 'woohoo_filter_not_selected_text',
								sprintf( apply_filters( 'woohoo_filter_not_selected_mask', __( '- %s -', 'woohoo' ) ), $label )
							);
	}
}

if ( ! function_exists( 'woohoo_get_list_range' ) ) {
	/**
	 ...
	 */
	function woohoo_get_list_range( $from = 1, $to = 2, $prepend_inherit = false ) {
		$list = array();
		for ( $i = $from; $i <= $to; $i++ ) {
			$list[ $i ] = $i;
		}
...
if ( ! function_exists( 'woohoo_get_list_styles' ) ) {
	/**
	 ...
	 */
	function woohoo_get_list_styles( $from = 1, $to = 2, $prepend_inherit = false ) {
		$list = array();
		for ( $i = $from; $i <= $to; $i++ ) {
			// Translators: Add number to the style name 'Style 1', 'Style 2' ...
			$list[ $i ] = sprintf( esc_html__( 'Style %d', 'woohoo' ), $i );
		}
		return $prepend_inherit ? woohoo_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'woohoo' ) ), $list ) : $list;
	}
}

if ( ! function_exists( 'woohoo_get_list_yesno' ) ) {
	/**
	 ...
	 */
	function woohoo_get_list_yesno( $prepend_inherit = false ) {
		$list = array(
			'yes' => esc_html__( 'Yes', 'woohoo' ),
			'no'  => esc_html__( 'No', 'woohoo' ),
		);
		return $prepend_inherit ? woohoo_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'woohoo' ) ), $list ) : $list;
	}
}

if ( ! function_exists( 'woohoo_get_list_checkbox_values' ) ) {
	/**
	 ...
	 * @return array                 An associative array with 'yes' and 'no' elements.
	 */
	function woohoo_get_list_checkbox_values( $prepend_inherit = false ) {
		$list = apply_filters(
			'woohoo_filter_list_checkbox_values', array(
				1         => esc_html__( 'Yes', 'woohoo' ),
				0         => esc_html__( 'No', 'woohoo' ),
			)
		);
		return $prepend_inherit ? woohoo_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'woohoo' ) ), $list ) : $list;
	}
...
if ( ! function_exists( 'woohoo_get_list_onoff' ) ) {
	/**
	 ...
	 */
	function woohoo_get_list_onoff( $prepend_inherit = false ) {
		$list = array(
			'on'  => esc_html__( 'On', 'woohoo' ),
			'off' => esc_html__( 'Off', 'woohoo' ),
		);
		return $prepend_inherit ? woohoo_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'woohoo' ) ), $list ) : $list;
	}
}

if ( ! function_exists( 'woohoo_get_list_showhide' ) ) {
	/**
	 ...
	 */
	function woohoo_get_list_showhide( $prepend_inherit = false ) {
		$list = array(
			'show' => esc_html__( 'Show', 'woohoo' ),
			'hide' => esc_html__( 'Hide', 'woohoo' ),
		);
		return $prepend_inherit ? woohoo_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'woohoo' ) ), $list ) : $list;
	}
}

if ( ! function_exists( 'woohoo_get_list_visiblehidden' ) ) {
	/**
	 ...
	 */
	function woohoo_get_list_visiblehidden( $prepend_inherit = false ) {
		$list = array(
			'visible' => esc_html__( 'Visible', 'woohoo' ),
			'hidden'  => esc_html__( 'Hidden', 'woohoo' ),
		);
		return $prepend_inherit ? woohoo_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'woohoo' ) ), $list ) : $list;
	}
}

if ( ! function_exists( 'woohoo_get_list_directions' ) ) {
	/**
	 ...
	 */
	function woohoo_get_list_directions( $prepend_inherit = false ) {
		$list = array(
			'horizontal' => esc_html__( 'Horizontal', 'woohoo' ),
			'vertical'   => esc_html__( 'Vertical', 'woohoo' ),
		);
		return $prepend_inherit ? woohoo_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'woohoo' ) ), $list ) : $list;
	}
}

if ( ! function_exists( 'woohoo_get_list_paddings' ) ) {
	/**
	 ...
	 */
	function woohoo_get_list_paddings( $prepend_inherit = false ) {
		$list = apply_filters(
			'woohoo_filter_list_paddings', array(
				'none'  => array(
							'title' => esc_html__( 'No Padding', 'woohoo' ),
							'icon'  => 'images/theme-options/section-padding/none.png',
						),
				'small'  => array(
							'title' => esc_html__( 'Small Padding', 'woohoo' ),
							'icon'  => 'images/theme-options/section-padding/small.png',
						),
				'medium' => array(
							'title' => esc_html__( 'Medium Padding', 'woohoo' ),
							'icon'  => 'images/theme-options/section-padding/medium.png',
						),
				'large' => array(
							'title' => esc_html__( 'Large Padding', 'woohoo' ),
...
if ( ! function_exists( 'woohoo_get_list_hovers' ) ) {
	/**
	 ...
	 */
	function woohoo_get_list_hovers( $prepend_inherit = false ) {
		$list = apply_filters(
			'woohoo_filter_list_hovers', array(
				'dots'    => esc_html__( 'Dots', 'woohoo' ),
				'icon'    => esc_html__( 'Icon', 'woohoo' ),
				'icons'   => esc_html__( 'Icons', 'woohoo' ),
				'zoom'    => esc_html__( 'Zoom', 'woohoo' ),
				'fade'    => esc_html__( 'Fade', 'woohoo' ),
				'slide'   => esc_html__( 'Slide', 'woohoo' ),
				'pull'    => esc_html__( 'Pull', 'woohoo' ),
				'border'  => esc_html__( 'Border', 'woohoo' ),
				'excerpt' => esc_html__( 'Excerpt', 'woohoo' ),
				'info'    => esc_html__( 'Info', 'woohoo' ),
			)
		);
		return $prepend_inherit ? woohoo_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'woohoo' ) ), $list ) : $list;
	}
...
if ( ! function_exists( 'woohoo_get_list_blog_contents' ) ) {
	/**
	 ...
	 */
	function woohoo_get_list_blog_contents( $prepend_inherit = false ) {
		$list = array(
				'excerpt'  => esc_html__( 'Excerpt', 'woohoo' ),
				'fullpost' => esc_html__( 'Full post', 'woohoo' ),
		);
		return $prepend_inherit ? woohoo_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'woohoo' ) ), $list ) : $list;
	}
}

if ( ! function_exists( 'woohoo_get_list_blog_paginations' ) ) {
	/**
	 ...
	 *                               This format used to show elements in the 'icons' style instead dropdown.
	 */
	function woohoo_get_list_blog_paginations( $prepend_inherit = false ) {
		$list = array(
					'pages'    => array(
					...
					'links'    => array(
										'title' => esc_html__( 'Older/Newest', 'woohoo' ),
...
if ( ! function_exists( 'woohoo_get_list_sidebars' ) ) {
	/**
	 ...
	 */
	function woohoo_get_list_sidebars( $prepend_inherit = false, $add_hide = false ) {
		$list = woohoo_storage_get( 'list_sidebars' );
		if ( '' == $list ) {
			...
			woohoo_storage_set( 'list_sidebars', $list );
		}
		if ( $add_hide ) {
			$list = woohoo_array_merge( array( 'hide' => woohoo_get_not_selected_text( esc_html__( 'Select widgets', 'woohoo' ) ) ), $list );
		}
		return $prepend_inherit ? woohoo_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'woohoo' ) ), $list ) : $list;
	}
}

if ( ! function_exists( 'woohoo_get_list_sidebars_positions' ) ) {
	/**
	 ...
	 *                               This format used to show elements in the 'icons' style instead dropdown.
	 */
	function woohoo_get_list_sidebars_positions( $prepend_inherit = false ) {
		$list = apply_filters(
			'woohoo_filter_list_sidebars_positions', array(
				'hide'  => array(
							'title' => esc_html__( 'No sidebar', 'woohoo' ),
							'icon'  => 'images/theme-options/sidebar-position/hide.png',
						),
				'left'  => array(
							'title' => esc_html__( 'Left sidebar', 'woohoo' ),
							'icon'  => 'images/theme-options/sidebar-position/left.png',
						),
				'right' => array(
							'title' => esc_html__( 'Right sidebar', 'woohoo' ),
...
if ( ! function_exists( 'woohoo_get_list_sidebars_positions_ss' ) ) {
	/**
	 ...
	 */
	function woohoo_get_list_sidebars_positions_ss( $prepend_inherit = false ) {
		$list = apply_filters(
			'woohoo_filter_list_sidebars_positions_ss', array(
				'above' => esc_html__( 'Above the content', 'woohoo' ),
				'below' => esc_html__( 'Below the content', 'woohoo' ),
				'float' => esc_html__( 'Floating bar', 'woohoo' ),
			)
		);
		return $prepend_inherit ? woohoo_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'woohoo' ) ), $list ) : $list;
	}
...
if ( ! function_exists( 'woohoo_get_list_sidebar_styles' ) ) {
	/**
	 ...
	 */
	function woohoo_get_list_sidebar_styles( $prepend_inherit = false ) {
		static $list = false;
		if ( ! $list ) {
			$list = apply_filters( 'woohoo_filter_list_sidebar_styles', array() );
		}
		return $prepend_inherit ? woohoo_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'woohoo' ) ), $list ) : $list;
	}
}

if ( ! function_exists( 'woohoo_get_list_header_footer_types' ) ) {
	/**
	 ...
	 */
	function woohoo_get_list_header_footer_types( $prepend_inherit = false ) {
		$list = apply_filters(
			'woohoo_filter_list_header_footer_types', array(
...
if ( ! function_exists( 'woohoo_get_list_header_styles' ) ) {
	/**
	 ...
	 */
	function woohoo_get_list_header_styles( $prepend_inherit = false ) {
		static $list = false;
		if ( ! $list ) {
			$list = apply_filters( 'woohoo_filter_list_header_styles', array() );
		}
		return $prepend_inherit ? woohoo_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'woohoo' ) ), $list ) : $list;
	}
}

if ( ! function_exists( 'woohoo_get_list_header_positions' ) ) {
	/**
	 ...
	 */
	function woohoo_get_list_header_positions( $prepend_inherit = false ) {
		$list = array(
			'default' => esc_html__( 'Default', 'woohoo' ),
			'over'    => esc_html__( 'Over', 'woohoo' ),
			'under'   => esc_html__( 'Under', 'woohoo' ),
		);
		return $prepend_inherit ? woohoo_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'woohoo' ) ), $list ) : $list;
	}
}

if ( ! function_exists( 'woohoo_get_list_footer_styles' ) ) {
	/**
	 ...
	 */
	function woohoo_get_list_footer_styles( $prepend_inherit = false ) {
		static $list = false;
		if ( ! $list ) {
			$list = apply_filters( 'woohoo_filter_list_footer_styles', array() );
		}
		return $prepend_inherit ? woohoo_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'woohoo' ) ), $list ) : $list;
	}
}

if ( ! function_exists( 'woohoo_get_list_body_styles' ) ) {
	/**
	 ...
	 *                                This format used to show elements in the 'icons' style instead dropdown.
	 */
	function woohoo_get_list_body_styles( $prepend_inherit = false, $force_fullscreen = false ) {
		$list = array(
			'boxed' => array(
						'title' => esc_html__( 'Boxed', 'woohoo' ),
						'icon'  => 'images/theme-options/body-style/boxed.png',
					),
			'wide'  => array(
						'title' => esc_html__( 'Wide', 'woohoo' ),
						'icon'  => 'images/theme-options/body-style/wide.png',
					),
		);
		if ( apply_filters( 'woohoo_filter_allow_fullscreen', $force_fullscreen || woohoo_get_theme_setting( 'allow_fullscreen' ) || woohoo_get_edited_post_type() == 'page' ) ) {
			$list['fullwide']   = array(
									'title' => esc_html__( 'Fullwidth', 'woohoo' ),
									'icon'  => 'images/theme-options/body-style/fullwide.png',
									);
			$list['fullscreen'] = array(
									'title' => esc_html__( 'Fullscreen', 'woohoo' ),
									'icon'  => 'images/theme-options/body-style/fullscreen.png',
									);
		}
		$list = apply_filters( 'woohoo_filter_list_body_styles', $list );
		return $prepend_inherit
					? woohoo_array_merge(
							array( 
								'inherit' => array(
...
if ( ! function_exists( 'woohoo_get_list_expand_content' ) ) {
	/**
	 ...
	 *                               This format used to show elements in the 'icons' style instead dropdown.
	 */
	function woohoo_get_list_expand_content( $prepend_inherit = false, $narrow = false ) {
		$list = apply_filters(
			'woohoo_filter_list_expand_content', array_merge(
				( $narrow
					? array(
						'narrow' => array(
								'title' => esc_html__( 'Narrow', 'woohoo' ),
				...
				array(
					'normal' => array(
							'title' => esc_html__( 'Normal', 'woohoo' ),
...
if ( ! function_exists( 'woohoo_get_list_remove_margins' ) ) {
	/**
	 ...
	 *                               This format used to show elements in the 'icons' style instead dropdown.
	 */
	function woohoo_get_list_remove_margins( $prepend_inherit = false ) {
		$list = apply_filters(
			'woohoo_filter_list_remove_margins', array(
				'0'  => array(
							'title' => esc_html__( 'Margins On', 'woohoo' ),
							'icon'  => 'images/theme-options/remove-margins/on.png',
						),
				'1'  => array(
							'title' => esc_html__( 'Margins Off', 'woohoo' ),
...
if ( ! function_exists( 'woohoo_get_list_meta_parts' ) ) {
	/**
	 ...
	 */
	function woohoo_get_list_meta_parts( $prepend_inherit = false ) {
		$list = apply_filters(
			'woohoo_filter_list_meta_parts',
			array(
				'author'     => esc_html__( 'Post author', 'woohoo' ),
				'date'       => esc_html__( 'Published date', 'woohoo' ),
				'modified'   => esc_html__( 'Modified date', 'woohoo' ),
				'views'      => esc_html__( 'Views', 'woohoo' ),
				'likes'      => esc_html__( 'Likes', 'woohoo' ),
				'comments'   => esc_html__( 'Comments', 'woohoo' ),
				'share'      => esc_html__( 'Share links', 'woohoo' ),
				'categories' => esc_html__( 'Categories', 'woohoo' ),
				'edit'       => esc_html__( 'Edit link', 'woohoo' ),
			)
		);
...
if ( ! function_exists( 'woohoo_get_list_share_links_positions' ) ) {
	/**
	 ...
	 */
	function woohoo_get_list_share_links_positions( $prepend_inherit = false ) {
		$list = apply_filters(
			'woohoo_filter_list_share_links_positions',
			array(
...
if ( ! function_exists( 'woohoo_get_list_blog_styles' ) ) {
	/**
	 ...
	 *                                 This format used to show elements in the 'icons' style instead dropdown.
	 */
	function woohoo_get_list_blog_styles( $prepend_inherit = false, $filter = 'arh', $need_custom = true ) {
		$list   = array();
					...
					if ( 'arh' == $filter && isset( $v['columns'] ) && is_array( $v['columns'] ) ) {
						...
						foreach ( $v['columns'] as $col ) {
							...
							$list[ "{$k}_{$col}" ] = 'arh' == $filter
														? array(
															'title'   => sprintf( _n( '%1$s %2$d Column', '%1$s %2$d Columns', $col, 'woohoo' ), $v['title'], $col ),
															'icon'    => ! empty( $v['icon'] )
																			? ( strpos( $v['icon'], '%d' ) !== false ? sprintf( $v['icon'], $col ) : $v['icon'] )
																			: 'images/theme-options/blog-style/custom.png',
															'new_row' => $new_row,
															)
														: sprintf( _n( '%1$s %2$d Column', '%1$s %2$d Columns', $col, 'woohoo' ), $v['title'], $col );
							$new_row = false;
						}
					} else {
						$list[ $k ] = 'arh' == $filter
		...
		$list = apply_filters( 'woohoo_filter_list_blog_styles', $list, $filter, $need_custom );
		return $prepend_inherit
					? woohoo_array_merge(
							array( 
								'inherit' => array(
...
if ( ! function_exists( 'woohoo_get_list_single_styles' ) ) {
	/**
	 ...
	 *                                 This format used to show elements in the 'icons' style instead dropdown.
	 */
	function woohoo_get_list_single_styles( $prepend_inherit = false ) {
		$list = apply_filters( 'woohoo_filter_list_single_styles', woohoo_storage_get( 'single_styles' ) );
		return $prepend_inherit
					? woohoo_array_merge(
							array( 
								'inherit' => array(
...
if ( ! function_exists( 'woohoo_get_list_categories' ) ) {
	/**
	 ...
	 */
	function woohoo_get_list_categories( $prepend_inherit = false ) {
		$list = woohoo_storage_get( 'list_categories' );
		if ( '' == $list ) {
			$list       = array();
			...
			if ( is_array( $taxonomies ) && count( $taxonomies ) > 0 ) {
				foreach ( $taxonomies as $cat ) {
					$list[ $cat->term_id ] = apply_filters( 'woohoo_filter_term_name', $cat->name, $cat );
				}
			}
			woohoo_storage_set( 'list_categories', $list );
		}
		return $prepend_inherit ? woohoo_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'woohoo' ) ), $list ) : $list;
	}
}

if ( ! function_exists( 'woohoo_get_list_terms' ) ) {
	/**
	 ...
	 */
	function woohoo_get_list_terms( $prepend_inherit = false, $taxonomy = 'category' ) {
		$list = woohoo_storage_get( 'list_taxonomies_' . ( $taxonomy ) );
		if ( '' == $list ) {
			$list       = array();
			...
			if ( is_array( $taxonomies ) && count( $taxonomies ) > 0 ) {
				foreach ( $taxonomies as $cat ) {
					...
					$list[ $cat->term_id ] = apply_filters( 'woohoo_filter_term_name', $cat->name . ( false && 'category' != $taxonomy ? " /{$cat->taxonomy}/" : '' ), $cat );
				}
			}
			woohoo_storage_set( 'list_taxonomies_' . ( $taxonomy ), $list );
		}
		return $prepend_inherit ? woohoo_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'woohoo' ) ), $list ) : $list;
	}
}

if ( ! function_exists( 'woohoo_get_list_posts_types' ) ) {
	/**
	 ...
	 */
	function woohoo_get_list_posts_types( $prepend_inherit = false ) {
		$list = woohoo_storage_get( 'list_posts_types' );
		if ( '' == $list ) {
			$list = apply_filters(
				'woohoo_filter_list_posts_types', array(
					'post' => esc_html__( 'Post', 'woohoo' ),
				)
			);
			woohoo_storage_set( 'list_posts_types', $list );
		}
		return $prepend_inherit ? woohoo_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'woohoo' ) ), $list ) : $list;
	}
}

if ( ! function_exists( 'woohoo_get_list_posts' ) ) {
	/**
	 ...
	 */
	function woohoo_get_list_posts( $prepend_inherit = false, $opt = array() ) {
		$opt = array_merge(
			array(
				'post_type'        => 'post',
				'post_status'      => 'publish',
		...
		$list = woohoo_storage_get( $hash );
		if ( '' == $list ) {
			$list = array();
			if ( false !== $opt['not_selected'] ) {
				$list['none'] = true === $opt['not_selected'] ? woohoo_get_not_selected_text( esc_html__( 'Not selected', 'woohoo' ) ) : $opt['not_selected'];
			}
			$args = array(
...
if ( ! function_exists( 'woohoo_get_list_users' ) ) {
	/**
	 ...
	 */
	function woohoo_get_list_users( $prepend_inherit = false, $roles = array( 'administrator', 'editor', 'author', 'contributor', 'shop_manager' ) ) {
		$list = woohoo_storage_get( 'list_users' );
		if ( '' == $list ) {
			$list         = array();
			$list['none'] = woohoo_get_not_selected_text( esc_html__( 'Not selected', 'woohoo' ) );
			$users        = get_users(
				array(
			...
			woohoo_storage_set( 'list_users', $list );
		}
		return $prepend_inherit ? woohoo_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'woohoo' ) ), $list ) : $list;
	}
}

if ( ! function_exists( 'woohoo_get_list_menus' ) ) {
	/**
	 ...
	 */
	function woohoo_get_list_menus( $prepend_inherit = false ) {
		$list = woohoo_storage_get( 'list_menus' );
		if ( '' == $list ) {
			$list            = array();
			$list['default'] = esc_html__( 'Default', 'woohoo' );
			...
			woohoo_storage_set( 'list_menus', $list );
		}
		return $prepend_inherit ? woohoo_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'woohoo' ) ), $list ) : $list;
	}
}

if ( ! function_exists( 'woohoo_get_list_icons' ) ) {
	/**
	 ...
	 */
	function woohoo_get_list_icons( $style = 'icons', $prepend_inherit = false ) {
		$lists = get_transient( 'woohoo_list_icons' );
		if ( ! is_array( $lists ) || ! isset( $lists[ $style ] ) || ! is_array( $lists[ $style ] ) || count( $lists[ $style ] ) < 2 ) {
			if ( 'icons' == $style ) {
				$lists[ $style ] = woohoo_array_from_list( woohoo_get_list_icons_classes( $prepend_inherit ) );
			} elseif ( 'images' == $style ) {
				$lists[ $style ] = woohoo_get_list_images();
			} else { // 'svg'
				$lists[ $style ] = woohoo_get_list_images( false, 'svg' );
			}
			if ( is_admin() && is_array( $lists[ $style ] ) && count( $lists[ $style ] ) > 1 ) {
				set_transient( 'woohoo_list_icons', $lists, 6 * 60 * 60 );       // Store to the cache for 6 hours
			}
		}
		return $lists[ $style ];
	}
...
if ( ! function_exists( 'woohoo_get_list_icons_classes' ) ) {
	/**
	 ...
	 * @return array                  An associative array with icons.
	 */
	function woohoo_get_list_icons_classes( $prepend_inherit = false ) {
		static $list = false;
		if ( ! is_array( $list ) ) {
			$list = ! is_admin() ? array() : woohoo_parse_icons_classes( woohoo_get_file_dir( 'css/font-icons/css/fontello-codes.css' ) );
		}
		$list = ! is_array( $list ) ? array() : woohoo_array_merge( array( 'none' => 'none' ), $list );
		return $prepend_inherit ? woohoo_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'woohoo' ) ), $list ) : $list;
	}
}

if ( ! function_exists( 'woohoo_get_list_images' ) ) {
	/**
	 ...
	 */
	function woohoo_get_list_images( $prepend_inherit = false, $type = 'png' ) {
...
if ( ! function_exists( 'woohoo_get_list_sc_color_styles' ) ) {
	/**
	 ...
	 */
	function woohoo_get_list_sc_color_styles( $prepend_inherit = false ) {
		$list = apply_filters(
			'woohoo_filter_get_list_sc_color_styles', array(
				'default' => esc_html__( 'Default', 'woohoo' ),
				'link2'   => esc_html__( 'Accent 2', 'woohoo' ),
				'link3'   => esc_html__( 'Accent 3', 'woohoo' ),
				'dark'    => esc_html__( 'Dark', 'woohoo' ),
			)
		);
		return $prepend_inherit ? woohoo_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'woohoo' ) ), $list ) : $list;
	}
