 ...
 */
class Woohoo_Elementor_Control_Choice extends \Elementor\Base_Data_Control {
	...
	public function enqueue() {
		wp_enqueue_script( 'woohoo-elementor-choice-control', woohoo_get_file_url( 'plugins/elementor/params/choice/choice-control.js'), array('jquery'), null, true );
	}
						...
						_.each( data.options, function( params, slug ) {
							print( ( params.new_row !== undefined
									...
									+ '<span tabindex="0" class="woohoo_list_choice_item'
												+ ( ( slug == data.controlValue && '' !== data.controlValue ) || ( 'inherit' == slug && '' === data.controlValue ) ? ' woohoo_list_active' : '' )
												+ '"'
										+ ' data-choice="' + slug + '"'
