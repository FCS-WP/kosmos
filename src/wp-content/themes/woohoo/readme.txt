== Woo Hoo ==
Version: 1.17.0
Copyright: 2020, AncoraThemes
WordPress version: required at least 5.0, tested up to 5.5.3
...
Please install and activate it before starting to use the theme Woo Hoo.
...
Theme documentation is available on http://woohoo.ancorathemes.com/doc/
...
2) Icons (css/font-icons/*.*)
   The icon set used in Woo Hoo is Fontello.
